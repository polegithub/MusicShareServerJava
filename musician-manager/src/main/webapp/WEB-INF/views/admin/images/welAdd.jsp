...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/image/bootstrap.css">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/image/main.css">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/image/highlight.css">
...
<div class="container">
	<div class="text-left col-md-12 wrapper">
        ...
        <input type="hidden" id="domain" value="${pageContext.request.contextPath}">
        <input type="hidden" id="uptoken_url" value="${pageContext.request.contextPath}/image/token">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/qiniu.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/highlight.js"></script>
